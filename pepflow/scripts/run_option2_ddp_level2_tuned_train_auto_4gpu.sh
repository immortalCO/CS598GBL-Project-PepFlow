...
OUTPUT_ROOT="./outputs"
EXP_NAME="option2_grpo_level2_seqang_tuned_train4g"

# Tuned level2 defaults:
# - lower lr for harder seq+angles setting
# - stronger supervised anchor
# - single update per rollout for stability
# - moderately frequent old-policy sync
COMMON_ARGS=(
